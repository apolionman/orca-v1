...
export default function SignInForm() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error(signInData.error || 'Failed to sign in');
      ...
      // You can also extract the session here if needed:
      // const session = signInData.session;
  
      setMessage("Signed in successfully!");
      router.push('/');
      // TODO: handle session storage or cookies here if needed
